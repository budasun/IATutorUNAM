...
================================================================================
0. CÁLCULO INVISIBLE: Antes de generar el JSON, resuelve el problema en silencio. Si el resultado es X, no puedes elegir una respuesta Y. La coherencia es obligatoria.
